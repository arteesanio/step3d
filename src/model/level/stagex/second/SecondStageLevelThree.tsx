...
interface SecondStageLevelThreeProps {
    score: number;
...
const ROUTES = {
    NEXT_LEVEL: "/learn?lvl=4",
} as const;

export const SecondStageLevelThree = ({ score, s__score = () => { }, onToast = () => { } }: SecondStageLevelThreeProps) => {
    ...
    // const { SecondStageLevelThree_quizOptions } = useLanguageContext()
    ...
    return (<>
        {showQuiz && (
            <QuizModal
                quizSet={secondStage_levelSets[3]}
