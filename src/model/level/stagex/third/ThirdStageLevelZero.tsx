...
const ROUTES = {
    NEXT_LEVEL: "/learn?lvl=1&stage=3",
} as const;
...
export const ThirdStageLevelZero = ({ score, s__score = () => { }, onToast = () => { } }: ThirdStageLevelZeroProps) => {
    ...
    // const { ThirdStageLevelZero_quizOptions } = useLanguageContext()
    ...
    const { thirdStage_levelSets } = useLanguageContext()
    return (<>
        {showQuiz && (
            <QuizModal
                quizSet={thirdStage_levelSets[0]}
                onCorrect={handleCorrectAnswer}
                onIncorrect={handleIncorrectAnswer}
                levelName="Level Zero"
            />
        )}
